...
export const ALL_COMMODITIES = [
  ...
  { key: 'PALM_OIL', label: 'Palm Oil', category: 'Soft Commodities', unit: 'USD/lb' },
  { key: 'MILK', label: 'Milk', category: 'Livestock', unit: 'USD/cwt' },
...
export const TEMPLATES = {
  frozen_foods_me: {
    ...
    icon: '🧊',
    commodities: ['WHEAT', 'CORN', 'RICE', 'SOYBEANS', 'SUGAR', 'COFFEE', 'COCOA', 'PALM_OIL', 'MILK', 'FEEDER_CATTLE', 'LEAN_HOGS', 'BRENT_CRUDE', 'NATURAL_GAS'],
  ...
  dairy_livestock: {
    ...
    icon: '🥛',
    commodities: ['MILK', 'FEEDER_CATTLE', 'LEAN_HOGS', 'CORN', 'SOYBEANS', 'OATS', 'WHEAT'],
  ...
  coffee_cocoa: {
    ...
    icon: '☕',
    commodities: ['COFFEE', 'COCOA', 'SUGAR', 'PALM_OIL'],
